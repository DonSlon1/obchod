            ...
            <div >
                <div class="container">
                    ...
                    <div class="col">
                        ...
                        <!-- Controls -->
                        <div class="carousel-controls">
                            <a class="carousel-control-prev" href="#big-product-gallery" role="button" data-slide="prev">
                                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                <span class="sr-only">Previous</span>
                            </a>
                            <a class="carousel-control-next" href="#big-product-gallery" role="button" data-slide="next">
                                <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                <span class="sr-only">Next</span>
                            </a>
                        </div>
                    ...
                    <div class="col w-fitcontent mw-fitcontent  overflow-auto pt-2 lg-background" id="sideBar">
                        ...
                        while ($image = $images->fetch_assoc()) {
                            ...
                            <div class=" d-flex  align-items-center w-fitcontent borde bg-white p-1" >
                                <img src="./images/'. $image['Obrazek'] .'" alt="'.$image["Nazev"] .'" class="d-block mx-auto   cursor_pointer" style="width: 150px" data-slide-to="'.$index .'" data-target="#big-product-gallery" >
                            </div>
                            </div>');
                            $index=$index+1;
                        }
...
<!--    navigace mezi informacemi-->
    <ul class="nav nav-tabs mt-4" id="myTab" role="tablist">
        <li class="nav-item">
            ...
            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Parametry</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#Hodnocení" role="tab" aria-controls="profile" aria-selected="false">Recenze</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Foto a video</a>
        </li>
    </ul>
                         ...
                         <h5>'.$rov1["Jmeno"].' '.$rov1["Prijmeni"].' </h5>
                          ...
                          <div class="row ">
                            ...
                            if ($rov1["Obrazek"]!=null) {
                                ...
                                <div class="row">
                                    <img class="recenze_obrazek cursor_pointer" src="images/' . $rov1["Obrazek"] . '" data-target="#modalimg' . $modalnumber . '" data-toggle="modal">
                                </div>
                                </div>
                                <div class="modal fade" id="modalimg' . $modalnumber . '" tabindex="-1" role="dialog"  aria-hidden="true">
                                    <div class="modal-dialog modal-xl modal-dialog-centered " role="document" >
                                        <div class="modal-content p-3" >
                                            <img  src="images/' . $rov1["Obrazek"] . '">
                    ...
                    <div class="row row-cols-1">
                        ...
                        <?php
                            ...
                            echo '<div class="m-auto" style="max-width: fit-content">
                                      <img src="./images/'.$himage['H_Obrazek'].'" alt="'.$himage["Nazev"].'" class="mh-100 d-inline img-fluid " style="height: 10em;">
                                  </div>
                        ...
                        <div class="container mt-4 ">
                            ...
                            <div class="row" >
                                        ...
                                        <div class="container p-3 bb" id="klady">
                                            <div class="row ">
                                                ...
                                                <div class="col m-auto" >
                                                    <textarea class="form-control border-0 p-0 " oninput="auto_grow(this) " id="positive"
                                ...
                                <div class="col mb-4">
                                    <div class="row">
                                        ...
                                        <div class="container p-3 bb" id="zapory">
                                            <div class="row ">
                                                <div class="col pr-0 fitcont float-right">
                                                    <svg class="rev-icon neg-icon " focusable="false" viewBox="0 0 24 24" aria-hidden="true">
                                                        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4 11H8c-.55 0-1-.45-1-1s.45-1 1-1h8c.55 0 1 .45 1 1s-.45 1-1 1z"></path>
                                                    </svg>
                                                </div>
                                                <div class="col" >
                                                    <textarea class="form-control border-0 p-0" oninput="auto_grow(this)" id="negative"
                                ...
                                <div class="container pl-0">
                                    <div class="container m-2 w-max-100 w-fitcontent border  " id="ddforimg" style="display: none">
